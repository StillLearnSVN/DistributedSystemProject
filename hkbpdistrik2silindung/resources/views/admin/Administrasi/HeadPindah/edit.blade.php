...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Head Pindah</h4>
                    <h6 class="card-subtitle"> Form Edit Data Head Pindah </h6>
                    <form class="mt-4 needs-validation" action="{{ route('HeadPindah.update', $headPindah->id_head_pindah) }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                                ...
                                <label class="form-label" for="nama_jemaat">Nama Jemaat<span
                                        ...
                                        <select class="form-select" name="id_jemaat">
                                            ...
                                            @foreach ($jemaats as $jemaat)
                                                <option value="{{ $jemaat->id_jemaat }}" @if($headPindah->id_jemaat == $jemaat->id_jemaat) selected @endif>{{ $jemaat->gelar_depan }}{{ $jemaat->nama_depan }} {{ $jemaat->nama_belakang }} {{ $jemaat->gelar_belakang }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_gereja">
                                    ...
                                    <option value="{{ $gereja->id_gereja }}" @if($headPindah->id_gereja == $gereja->id_gereja) selected @endif>{{ $gereja->nama_gereja  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="no_surat_pindah" name="no_surat_pindah"
                                    value="{{ $headPindah->no_surat_pindah }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="tgl_pindah" name="tgl_pindah"
                                    value="{{ $headPindah->tgl_pindah }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="tgl_warta">Tanggal Warta<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tgl_warta" name="tgl_warta"
                                    value="{{ $headPindah->tgl_warta }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_gereja_tujuan">
                                    <option value="">Pilih Gereja</option>
                                    @foreach ($gerejas as $gereja)
                                    <option value="{{ $gereja->id_gereja }}" @if($headPindah->id_gereja_tujuan == $gereja->id_gereja) selected @endif>{{ $gereja->nama_gereja  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_gereja_no_hkbp" name="nama_gereja_no_hkbp"
                                    value="{{ $headPindah->nama_gereja_no_hkbp }}">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" rows="5" name="keterangan" placeholder="Masukkan Keterangan">{{ $headPindah->keterangan }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
