    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tambah Detail Pindah</h4>
                        <h6 class="card-subtitle"> Form Tambah Detail Pindah </h6>
                        <form class="mt-4 needs-validation" action="{{ route('DetailPindah.store') }}" method="POST"
                            novalidate>
                            @csrf
                            <div class="row">
