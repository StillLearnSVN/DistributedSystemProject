    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tambah Bidang Pendidikan</h4>
                        <h6 class="card-subtitle"> Form Tambah Bidang Pendidikan </h6>
                        <form class="mt-4 needs-validation" action="{{ route('BidangPendidikan.store') }}" method="POST"
                            novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01"
                                        name="nama_bidang_pendidikan" placeholder="Masukkan Bidang Pendidikan" required>
