        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle"> Form Edit City </h6>
                    @if (isset($city))
                    <form class="mt-4 needs-validation"
                        action="{{ route('City.update', $city->city_id) }}"
                        method="POST" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="city_name">City Name<span
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="province" name="prov_id" required>
                                    ...
                                    <option value="{{ $province->prov_id }}" {{ $province->prov_id == $city->prov_id ? 'selected' : '' }}>{{ $province->prov_name }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
