...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Gereja</h4>
                    <h6 class="card-subtitle"> Form Edit Gereja </h6>
                    <form class="mt-4 needs-validation" action="{{ route('Gereja.update', $gereja->id_gereja) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="gereja_name" name="nama_gereja"
                                    value="{{ $gereja->nama_gereja }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="pendeta_gereja">Nama Pendeta Gereja<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="pendeta_gereja" name="pendeta_gereja"
                                    value="{{ $gereja->pendeta_gereja }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="gereja_code" name="kode_gereja"
                                    value="{{ $gereja->kode_gereja }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="subdis_id" required>
                                    ...
                                    <option value="{{ $subdistrict->subdis_id }}"
                                        {{ $subdistrict->subdis_id == $gereja->subdis_id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_ressort" required>
                                    ...
                                    <option value="{{ $ressort->id_ressort }}"
                                        {{ $ressort->id_ressort == $gereja->id_ressort ? 'selected' : '' }}>
                                        {{ $ressort->nama_ressort }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                                    Pilih Ressort.
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="tgl_berdiri" name="tgl_berdiri"
                                    value="{{ $gereja->tgl_berdiri }}" required>
                                <div class="invalid-feedback">
