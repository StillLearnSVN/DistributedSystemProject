...
@section('content')
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        $('#detail_pendidikan').text(response.education.pendidikan);
                        $('#detail_keterangan').text(response.education.keterangan);
                    }
                }
            });
        });
        ...
        $(document).on('click', '.delete_pendidikan', function(e) {
            ...
            var deleteUrlTemplate = "{{ route('Pendidikan.delete', ['id' => ':id']) }}";
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Pendidikan</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb justify-content-end">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('Pendidikan.index') }}"
                                style="color:inherit">Pendidikan</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <h6 class="card-subtitle"> Daftar Pendidikan </h6>
                            </div>
                            <div class="ms-auto">
                                <a href="{{ route('Pendidikan.create') }}" style="color:inherit"
                                    class="pull-right btn btn-info d-lg-block m-l-15 text-white"><i class="ti-plus"> </i>
                                    Tambah Baru </a>
                            </div>
                        </div>
                        <div class="table-responsive mp-t-40">
                            <table id="config-table" class="table display table-striped border no-wrap">
                                ...
                                <tbody>
                                    @if (isset($pendidikans) && count($pendidikans) > 0)
                                        @foreach ($pendidikans as $edu)
                                            <tr>
                                                <td>{{ $edu['pendidikan'] }}</td>
                                                ...
                                                <td class="text-center" style="padding: 12px;">
                                                    <div class=" btn-group btn-group-sm">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            <button type="button" value="{{ $edu['id_pendidikan'] }}"
                                                            ...
                                                            <button type="button" class="dropdown-item text-info editBtn">
                                                                <i class="ti-pencil-alt me-2"></i><a
                                                                    href="{{ route('Pendidikan.edit', $edu['id_pendidikan']) }}"
                    ...
                    <div class="container-fluid">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-7 ms-auto">
                                <p class="form-control-static" id="detail_pendidikan"> </p>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-5">
            ...
            <div class="modal-content">
                ...
                <form id="editPendidikanForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger text-white delete_pendidikan"
