...
@section('content')
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        $('#detail_status').text(response.status.status);
                        $('#detail_jenis_status').text(response.status.jenis_status);
                        $('#detail_keterangan').text(response.status.keterangan);
                    }
                }
            });
        });
        ...
        $(document).on('click', '.delete_status', function(e) {
            ...
            var deleteUrlTemplate = "{{ route('Status.delete', ['id' => ':id']) }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        setTimeout("window.location='{{ route('Status.index') }}'", 1500);
                    } else {
                        $.toast({
                            heading: 'Success',
                            text: response.message,
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb justify-content-end">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('Status.index') }}"
                                style="color:inherit">Status</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <h6 class="card-subtitle"> Daftar Status </h6>
                            </div>
                            <div class="ms-auto">
                                <a href="{{ route('Status.create') }}" style="color:inherit"
            ...
            <div class="modal-content">
                ...
                <form id="editStatusForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger text-white delete_status"
