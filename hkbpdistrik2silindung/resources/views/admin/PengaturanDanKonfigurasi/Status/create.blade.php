            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle"> Form Tambah Status </h6>
                        <form class="mt-4 needs-validation" action="{{ route('Status.store') }}" method="POST" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="form-label" for="validationCustom01">Status<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="validationCustom01" name="status" placeholder="Masukkan Status" required>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" name="id_jenis_status">
                                        ...
                                        @foreach ($jenisStatuses as $jenisStatus)
                                            <option value="{{ $jenisStatus['id_jenis_status'] }}">{{ $jenisStatus['jenis_status'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
