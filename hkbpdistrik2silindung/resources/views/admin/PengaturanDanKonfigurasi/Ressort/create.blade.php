...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Ressort</h4>
                    <h6 class="card-subtitle"> Form Tambah Ressort Baru </h6>
                    <form class="mt-4 needs-validation" action="{{ route('Ressort.store') }}" method="POST"
                        novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="ressort_name" name="nama_ressort"
                                    placeholder="Masukkan Nama Ressort" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="pendeta_ressort" name="pendeta_ressort"
                                    placeholder="Masukkan Nama Pendeta Ressort" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="ressort_code" name="kode_ressort"
                                    placeholder="Masukkan Kode Ressort" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="ressort_address" name="alamat"
                                    placeholder="Masukkan Alamat Ressort" required>
                                <div class="invalid-feedback">
