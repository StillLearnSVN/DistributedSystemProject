    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Jenis Gereja</h4>
                        <h6 class="card-subtitle"> Form Edit Jenis Gereja </h6>
                        @if (isset($jenisGereja))
                        <form class="mt-4 needs-validation"
                            action="{{ route('JenisGereja.update', $jenisGereja['id_jenis_gereja']) }}"
                            method="POST" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="validationCustom01">Jenis Gereja<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="validationCustom01" name="jenis_gereja"
                                        value="{{ $jenisGereja['jenis_gereja'] }}"
                                        placeholder="Enter Jenis Gereja" required>
