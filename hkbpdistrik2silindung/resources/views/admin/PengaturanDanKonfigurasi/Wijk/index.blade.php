        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb justify-content-end">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('Wijk.index') }}"
                            style="color:inherit">Wijk</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            <h4 class="card-title">Data Wijk</h4>
                            <h6 class="card-subtitle"> Daftar Wijk </h6>
                        </div>
                        <div class="ms-auto">
                            <a href="{{ route('Wijk.create') }}" style="color:inherit"
                                        ...
                                        <td class="text-center" style="padding: 12px;">
                                            <div class=" btn-group btn-group-sm">
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    <button type="button" value="{{ $wijk->id_wijk }}" class="dropdown-item text-dark detailBtn">
                                                        <i class="ti-target"></i>Detail
                                                    </button>
                                                    <button type="button" class="dropdown-item text-info editBtn">
                                                        <i class="ti-pencil-alt me-2"></i><a href="{{ route('Wijk.edit', $wijk->id_wijk) }}"
                                                            style="color:inherit">Edit</a>
                                                    </button>
                                                    <button type="button" value="{{ $wijk->id_wijk }}" class="dropdown-item text-danger deleteBtn">
...
<!-- .modal for detail wijk -->
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Wijk</h4>
                ...
                <div class="container-fluid">
                    <div class="row mt-3">
                        ...
                        <div class="col-md-7 ms-auto">
                            <p class="form-control-static" id="detail_nama_wijk"> </p>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-5">
...
<!-- .modal for delete wijk -->
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Delete Wijk</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" class="btn-close" aria-label="Close">
                    <span aria-hidden="true"></span> </button>
            </div>
            <form id="editWijkForm">
                @csrf
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger text-white delete_wijk"
