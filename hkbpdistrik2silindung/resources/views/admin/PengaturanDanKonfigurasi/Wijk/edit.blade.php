...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Wijk</h4>
                    <h6 class="card-subtitle">Form Edit Wijk</h6>
                    @if (isset($wijk))
                    <form class="mt-4 needs-validation"
                        action="{{ route('Wijk.update', $wijk->id_wijk) }}"
                        method="POST" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="nama_wijk">Nama Wijk<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_wijk" name="nama_wijk"
                                    value="{{ $wijk->nama_wijk }}"
                                    placeholder="Enter Nama Wijk" required>
