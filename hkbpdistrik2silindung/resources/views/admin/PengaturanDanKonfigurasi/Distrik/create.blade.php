...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Distrik</h4>
                    <h6 class="card-subtitle"> Form Tambah Distrik Baru </h6>
                    <form class="mt-4 needs-validation" action="{{ route('Distrik.store') }}" method="POST"
                        novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="distrik_name" name="nama_distrik"
                                    placeholder="Masukkan Nama Distrik" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="praeses_distrik_name" name="nama_praeses"
                                    placeholder="Masukkan Nama Praeses" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="distrik_code" name="kode_distrik"
                                    placeholder="Masukkan Kode Distrik" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="distrik_code" name="alamat"
                                    placeholder="Masukkan Alamat Distrik" required>
                                <div class="invalid-feedback">
