...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Pelayan Gereja</h4>
                    <h6 class="card-subtitle"> Form Edit Data Pelayan Gereja </h6>
                    <form class="mt-4 needs-validation" action="{{ route('PelayanGereja.update', $pelayanGereja->id_pelayan_gereja) }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                                ...
                                <label class="form-label" for="nama_jemaat">Nama Jemaat<span
                                        ...
                                        <select class="form-select" name="id_jemaat">
                                            ...
                                            @foreach ($jemaats as $jemaat)
                                                <option value="{{ $jemaat->id_jemaat }}" {{ $pelayanGereja->id_jemaat == $jemaat->id_jemaat ? 'selected' : '' }}>{{ $jemaat->gelar_depan }}{{ $jemaat->nama_depan }} {{ $jemaat->nama_belakang }} {{ $jemaat->gelar_belakang }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="keterangan">Keterangan<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="keterangan" name="keterangan" value="{{ $pelayanGereja->keterangan }}" required>
                                <div class="invalid-feedback">
                    ...
                    <script>
                        ...
                        function redirectToIndex() {
                            window.location.href = "{{ route('PelayanGereja.index') }}";
                        }
                    </script>
                </div>
            </div>
