...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Pelayan Non Tahbisan</h4>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Pelayan Non Tahbisan</h4>
                    <h6 class="card-subtitle"> Form Edit Data Pelayan Non Tahbisan </h6>
                    <form class="mt-4 needs-validation" action="{{ route('PelayanNonTahbisan.update', $pelayanNonTahbisan->id_pelayanan_nonTahbisan) }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="nama_jemaat">Nama Jemaat<span
                                        class="text-danger">*</span></label>
                                        <select class="form-select" name="id_majelis" required>
                                            <option value="">Nama Majelis</option>
                                            @foreach ($majelis as $majels)
                                                <option value="{{ $majels->id_jemaat }}" {{ $majels->id_majelis == $majels->id_jemaat ? 'selected' : '' }}>{{ $majels->gelar_depan }}{{ $majels->nama_depan }} {{ $majels->nama_belakang }} {{ $majels->gelar_belakang }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="pelayan_gereja">Pelayan Gereja<span
                                        class="text-danger">*</span></label>
                                        <select class="form-select" name="id_pelayan_gereja" required>
                                            <option value="">Nama Majelis</option>
                                            @foreach ($pelayanGereja as $pg)
                                                <option value="{{ $pg->id_pelayan_gereja }}" {{ $pg->id_pelayan_gereja == $pg->id_pelayan_gereja ? 'selected' : '' }}>{{ $pg->gelar_depan }}{{ $pg->nama_depan }} {{ $pg->nama_belakang }} {{ $pg->gelar_belakang }}</option>
                                            @endforeach
                                        </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="status_pelayanan">Status Pelayanan<span
                                        class="text-danger">*</span></label>
                                        <select class="form-select" name="id_status_pelayanan" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="nama_pelayanan_nonTahbisan">Nama Pelayanan Non Tahbisan<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_pelayanan_nonTahbisan" name="nama_pelayanan_nonTahbisan" value="{{ $pelayanNonTahbisan->nama_pelayanan_nonTahbisan }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="tgl_pengangkatan">Tanggal Pengangkatan<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tgl_pengangkatan" name="tgl_pengangkatan" value="{{ $pelayanNonTahbisan->tgl_pengangkatan }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="tgl_berakhir">Tanggal Berakhir<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tgl_berakhir" name="tgl_berakhir" value="{{ $pelayanNonTahbisan->tgl_berakhir }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan">{{ $pelayanNonTahbisan->keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="text-end">
