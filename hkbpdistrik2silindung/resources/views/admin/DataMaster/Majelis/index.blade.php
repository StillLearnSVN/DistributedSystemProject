...
<script>
    ...
    $(document).on('click', '.detailBtn', function(e) {
        ...
        var majelisId = $(this).val();

        $("#detailModal").modal('show');

        $.ajax({
            method: "GET",
            url: "{{ route('Majelis.detail') }}",
            data: {
                id: majelisId
            },
            success: function(response) {
                if (response.status == 404) {
                    ...
                    $('#detail_nama_jemaat').text(response.majelis.gelar_depan + ' ' + response.majelis.nama_depan + ' ' + response.majelis.nama_belakang + ' ' + response.majelis.gelar_belakang);
                    $('#detail_status_pelayanan').text(response.majelis.status);
                    $('#detail_gereja').text(response.majelis.gereja_name);
                    $('#detail_tgl_tahbis').text(response.majelis.tgl_tahbis);
                    $('#detail_tgl_akhir_jawatan').text(response.majelis.tgl_akhir_jawatan);
                }
            }
        });
    });
    ...
    $(document).on('click', '.deleteBtn', function(e) {
        ...
        $('#deleting_id').val(majelisId);
    });

    //-------------------------------------------------------------------------------------------------
    //Ajax Delete Data
    //-------------------------------------------------------------------------------------------------
    $(document).on('click', '.delete_majelis', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 404) {
                    ...
                    setTimeout("window.location='{{ route('Majelis.index') }}'", 1500);
                } else {
                    $.toast({
                        heading: 'Success',
                        text: response.message,
                ...
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            ...
                            <h6 class="card-subtitle"> Daftar Majelis </h6>
                        </div>
                        <div class="ms-auto">
                            <a href="{{ route('Majelis.create') }}" style="color:inherit"
                        ...
                        <table id="config-table" class="table display table-striped border no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Gereja</th>
                                    <th>Tanggal Tahbis</th>
                                    <th>Tanggal Akhir Jawatan</th>
                                ...
                                @if (isset($majelis) && count($majelis) > 0)
                                    @foreach ($majelis as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->tgl_tahbis }}</td>
                                            <td>{{ $data->tgl_akhir_jawatan }}</td>
                                                    ...
                                                    <div class="dropdown-menu" style="">
                                                        ...
                                                        <button type="button" class="dropdown-item text-info editBtn">
                                                            <i class="ti-pencil-alt me-2"></i><a
                                                                href="{{ route('Majelis.edit', $data->id_majelis) }}"
...
<!-- .modal for detail majelis -->
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Majelis</h4>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-5">
                            <label class="control-label text-end">Tanggal Tahbis:</label>
                        </div>
                        <div class="col-md-7 ms-auto">
                            <p class="form-control-static" id="detail_tgl_tahbis"> </p>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-5">
                            <label class="control-label text-end">Tanggal Akhir Jawatan:</label>
                        </div>
                        <div class="col-md-7 ms-auto">
                            <p class="form-control-static" id="detail_tgl_akhir_jawatan"> </p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- .modal for delete majelis -->
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Delete Majelis</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" class="btn-close" aria-label="Close">
                    <span aria-hidden="true"></span> </button>
            </div>
            <form id="editMajelisForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger text-white delete_majelis"
