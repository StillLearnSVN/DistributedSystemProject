...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Majelis</h4>
                    <h6 class="card-subtitle"> Form Edit Data Majelis </h6>
                    <form class="mt-4 needs-validation" action="{{ route('Majelis.update', $majelis->id_majelis) }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                                ...
                                <label class="form-label" for="nama_jemaat">Nama Jemaat<span
                                        ...
                                        <select class="form-select" name="id_jemaat">
                                            ...
                                            @foreach ($jemaats as $jemaat)
                                                <option value="{{ $jemaat->id_jemaat }}" {{ $majelis->id_jemaat == $jemaat->id_jemaat ? 'selected' : '' }}>{{ $jemaat->gelar_depan }}{{ $jemaat->nama_depan }} {{ $jemaat->nama_belakang }} {{ $jemaat->gelar_belakang }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="tgl_tahbis">Tanggal Tahbis<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tgl_tahbis" name="tgl_tahbis" value="{{ $majelis->tgl_tahbis }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="tgl_akhir_jawatan">Tanggal Akhir Jawatan<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tgl_akhir_jawatan" name="tgl_akhir_jawatan" value="{{ $majelis->tgl_akhir_jawatan }}" required>
                                <div class="invalid-feedback">
