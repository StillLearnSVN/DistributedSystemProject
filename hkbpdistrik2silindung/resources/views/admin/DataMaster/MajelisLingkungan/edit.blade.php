...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Majelis Lingkungan</h4>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Majelis Lingkungan</h4>
                    <h6 class="card-subtitle"> Form Edit Data Majelis Lingkungan </h6>
                    <form class="mt-4 needs-validation" action="{{ route('MajelisLingkungan.update', $majelisLingkungan->id_majelis) }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_majelis">
                                    ...
                                    @foreach ($majelis as $majels)
                                        <option value="{{ $majels->id_jemaat }}" {{ $majels->id_jemaat == $majelisLingkungan->id_majelis ? 'selected' : '' }}>{{ $majels->gelar_depan }}{{ $majels->nama_depan }} {{ $majels->nama_belakang }} {{ $majels->gelar_belakang }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_wijk">
                                    ...
                                    @foreach ($wijks as $wijk)
                                        <option value="{{ $wijk->id_wijk }}" {{ $wijk->id_wijk == $majelisLingkungan->id_wijk ? 'selected' : '' }}>{{ $wijk->nama_wijk }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
