...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Baptis</h4>
                    <h6 class="card-subtitle"> Form Tambah Data Baptis Baru </h6>
                    <form class="mt-4 needs-validation" action="{{ route('Baptis.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="no_surat_baptis" name="no_surat_baptis"
                                    placeholder="Masukkan Nomor Surat Baptis" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_pendeta_baptis"
                                    name="nama_pendeta_baptis" placeholder="Masukkan Nama Pendeta Baptis" required>
                                <div class="invalid-feedback">
                                    Nama Pendeta Baptis tidak boleh kosong.
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="file_surat_baptis">File Surat Baptis<span
                                        class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="file_surat_baptis" name="file_surat_baptis"
                                    required>
                                <div class="invalid-feedback">
