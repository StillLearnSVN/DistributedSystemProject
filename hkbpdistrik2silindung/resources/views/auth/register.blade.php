...
<head>
    ...
    <title>SIAK HKBP PALMARUM - Daftar</title>
...
<body>
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Daftar</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(../assets/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="mt-4 needs-validation" action="{{ route('register') }}" method="POST" novalidate>
                    ...
                    <h3 class="box-title m-t-40 m-b-0">Daftar</h3><small>Buat akun dan kelola data HKBP Palmarum</small>
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" placeholder="Name" value="{{ old('name') }}" autocomplete="off" required>
                            @error('name')
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg w-100 text-uppercase btn-rounded text-white" type="submit">Daftar</button>
                        </div>
                    </div>
                    {{-- <div class="row">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            Sydah punya Akun? <a href="{{ route('login') }}" class="text-info m-l-5"><b>Masuk disini </b></a>
                        </div>
                    </div>
                </form>
