...
<head>
    ...
    <title>SIAK HKBP PALMARUM - Ubah Password</title>
...
<body>
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Ubah Password</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(../assets/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="mt-4 needs-validation" action="{{ route('user-password.update') }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <h3 class="box-title m-t-40 m-b-0">Ubah Password</h3>

                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <input class="form-control @error('current_password', 'updatePassword') is-invalid @enderror" type="password" name="current_password" placeholder="Current Password" required>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <input class="form-control @error('password', 'updatePassword') is-invalid @enderror" type="password" name="password" placeholder="Password" required autocomplete="new-password">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg w-100 text-uppercase btn-rounded text-white" type="submit">Save</button>
                        </div>
                    </div>
                </form>
